...
public class MenuKeyboard {
    public final List<String> EXPENSES = List.of("Еда", "Алкоголь", "Транспорт", "Жилье", "Депозит", "Прочее");
    public final List<String> INCOME = List.of("Зарплата", "Подарки", "Снятие с депозита", "Прочее");
